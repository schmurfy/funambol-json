...
public class BeginConverter implements Converter<String> {

    /**
     * 
     */
    public String fromJSON(String jsonContent) {
        return null;        
    }


    /** (non-Javadoc)
     * it creates the following json object
     * {"data":{"since":1222957120830}}
     */
    public String toJSON(String input) {
        JSONObject jsonRoot = new JSONObject();
        JSONObject jsonData = JSONObject.fromObject(input);
