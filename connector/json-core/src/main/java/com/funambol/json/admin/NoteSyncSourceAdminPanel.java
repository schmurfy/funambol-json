...
import com.funambol.json.engine.source.NoteSyncSource;


/**
 * This class implements the configuration panel for NoteSyncSource
 * 
 * @version $Id:$
 */

public class NoteSyncSourceAdminPanel extends SourceManagementPanel
implements Serializable {
    ...
    protected static final String TYPE_LABEL_PLAINTEXT  = "Plain Text";

    protected static final String TYPE_SIFN       = "text/x-s4j-sifn";
    protected static final String TYPE_PLAINTEXT  = "text/plain";

    protected static final String VERSION_SIFN       = "1.0";
    protected static final String VERSION_PLAINTEXT  = "1.0";
        
    private static final String PANEL_NAME = "Edit Note SyncSource";
     ...
     */
    public NoteSyncSourceAdminPanel() {
        init();
    }
            ...
            public void actionPerformed(ActionEvent event ) {
                try {
                    ...
                    if (getState() == STATE_INSERT) {
                        NoteSyncSourceAdminPanel.this.actionPerformed(
                                new ActionEvent(NoteSyncSourceAdminPanel.this,
    ...
    public void updateForm() {
        ...
        if (!(getSyncSource() instanceof NoteSyncSource)) {
            notifyError(
                    new AdminException("This is not a NoteSyncSource! "
    ...
    private List getTypes() {
        ...
        supportedTypes.add(TYPE_LABEL_PLAINTEXT);
    ...
    private String getTypeToSelect(SyncSource syncSource) {
        ...
        if (syncSource.getInfo() != null &&
            ...
            if (TYPE_PLAINTEXT.equals(preferredType)) {
                return TYPE_LABEL_PLAINTEXT;
            }
    ...
    public void setSyncSourceInfo(SyncSource syncSource, String selectedType) {
        NoteSyncSource pimSource = (NoteSyncSource)syncSource;
        ...
        } else if (TYPE_LABEL_PLAINTEXT.equals(selectedType)) {
            contentTypes = new ContentType[1];
            contentTypes[0] = new ContentType(TYPE_PLAINTEXT, VERSION_PLAINTEXT);
        }
