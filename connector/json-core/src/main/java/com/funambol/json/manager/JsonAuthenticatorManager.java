...
public interface JsonAuthenticatorManager {
    
    /**
     * @param request the JsonAuthRequest containing the username and password
     ...
     * @throws DaoException
     */
    public JsonAuthResponse login(JsonAuthRequest request) throws BadRequestException, UnauthorizedException, InternalServerErrorException, MalformedJsonContentException, DaoException;
    
    /**
     * @param  user the JsonUser to logout 
     * @throws BadRequestException
     * @throws UnauthorizedException
     * @throws InternalServerErrorException
     * @throws MalformedJsonContentException
     * @throws DaoException
     */
    public void logout(JsonUser user) throws BadRequestException, UnauthorizedException, InternalServerErrorException, MalformedJsonContentException, DaoException;

    /**
     *
     * @param customerUserIdLabel
     */
