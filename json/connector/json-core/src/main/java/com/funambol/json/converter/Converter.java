...
public interface Converter<T> {
    ...
    /**
     * @param obj the object to transform in json format
     * @return a json string
     */
    public String toJSON(T obj);
    
    /**
     * @param jsonContent the json string to transform in object
     * @return an object containing the json content information
     */
