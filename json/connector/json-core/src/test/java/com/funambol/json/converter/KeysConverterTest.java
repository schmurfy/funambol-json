...
public class KeysConverterTest extends TestCase {
    ...
    public void testKeysConverter() {
        ...
        JsonKeys keys = new JsonKeys();
        String[] stringArray = {"1","2","3"};
        keys.setKeys(stringArray);
        String jsonResult = converter.toJSON(keys);
        JsonKeys keys2 = converter.fromJSON(jsonResult);
        String jsonResult2 = converter.toJSON(keys2);
